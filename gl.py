...
class SkyrockRadioApp(Gtk.Window):
    def __init__(self):
        ...
        self.config_file = os.path.expanduser("~/.Gleaphe_radio.conf")
        ...
        self.title_label = Gtk.Label(label="Gleaphe Radio")
    ...
    def apply_cyberpunk_css(self):
        """Applique un style CSS cyberpunk bleu cyan avec arrière-plan personnalisé."""
        css = """
        window {
            background-image: url('gleaphe.jpg');
